...
{
  this->use_half_step = 0; // 20091103JZ - This is the original constructor, we are not gonna use half-step
  ...
  if (millis() - this->last_step_time >= this->step_delay) {
      ...
      steps_left--;
          ...
          if (this->use_half_step)
          {
              ...
              stepMotor(this->step_number % 8);// JZ 20091104
          } else {
...
void Stepper::stepMotor(int thisStep)
{
  ...
  if ((this->pin_count == 4) && (this->use_half_step == 0)) {
    switch (thisStep) {
      case 0:    // 1010
      digitalWrite(motor_pin_1, HIGH);
      digitalWrite(motor_pin_2, LOW);
  ...
  if ((this->pin_count == 4) && (this->use_half_step == 1)) {
    switch (thisStep) {
      case 0:    // 1010
      digitalWrite(motor_pin_1, HIGH);
      digitalWrite(motor_pin_2, LOW);

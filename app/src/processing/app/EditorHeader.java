...
public class EditorHeader extends JComponent {
  ...
  public void rebuildMenu() {
    ...
    */
    ...
    item = Editor.newJMenuItemShift(getString("New Tab"), 'N');
    item.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
    ...
    item = new JMenuItem(getString("Rename"));
    item.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
    ...
    item = new JMenuItem(getString("Delete"));
    item.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
    ...
    item = new JMenuItem(getString("Previous Tab"));
    ...
    item = new JMenuItem(getString("Next Tab"));

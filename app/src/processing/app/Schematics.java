  ...
  public Schematics(String path) {
    ...
    label.addMouseMotionListener(new MouseMotionListener() {
        public void mouseDragged(MouseEvent e) {
          ...
          diagramY = Math.max(d1.height - (d.height + GUI_BIG + GUI_BETWEEN + BUTTON_HEIGHT + GUI_BIG + GUI_BIG), diagramY);
    ...
    d2 = resetButton.getPreferredSize();
    ...
    setSize(Math.min(screen.width,wide + insets.left + insets.right),
                  Math.min(screen.height,high + insets.top + insets.bottom));

...
Arduinos usually are used to repeat a task over and over multiple times. Raspberry Pis on
the other hand usually have a proccesor that is capable of multi-tasking affectively.

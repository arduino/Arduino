...
/*  Constructors                             */
/*********************************************/
String::String(const char *cstr, unsigned int bufferSize)
{
  init(bufferSize);
...
//----------------------------------------
String::String(const String &value, unsigned int bufferSize)
{
  init(bufferSize);
  *this = value;
}
...
//----------------------------------------
String::String(const __FlashStringHelper *pstr, unsigned int bufferSize)
{
  init(bufferSize);
  *this = pstr;
}
...
//----------------------------------------
String::String(char c, unsigned int bufferSize)
{
  init(bufferSize);
  char buf[2];
  buf[0] = c;
...
//----------------------------------------
String::String(unsigned char value, unsigned char base, unsigned int bufferSize)
{
  init(bufferSize);
...
//----------------------------------------
String::String(int value, unsigned char base, unsigned int bufferSize)
{
  init(bufferSize);
...
//----------------------------------------
String::String(unsigned int value, unsigned char base, unsigned int bufferSize)
{
  init(bufferSize);
...
//----------------------------------------
String::String(long value, unsigned char base, unsigned int bufferSize)
{
  init(bufferSize);
...
//----------------------------------------
String::String(unsigned long value, unsigned char base, unsigned int bufferSize)
{
  init(bufferSize);
...
//----------------------------------------
String::String(float value, unsigned char decimalPlaces, unsigned int bufferSize)
{
  init(bufferSize);
  char buf[33];
...
//----------------------------------------
String::String(double value, unsigned char decimalPlaces, unsigned int bufferSize)
{
  init(bufferSize);
  char buf[33];
  *this = dtostrf(value, (decimalPlaces + 2), decimalPlaces, buf);
...
//----------------------------------------
inline void String::init(unsigned int bufferSize)
{
  buffer    = NULL;
  capacity  = 0;
  len       = 0;
...
unsigned char String::reserve(unsigned int size)
{
  ...
  unsigned int minNewSize = (capacity > 0 ? capacity : size) * (1.0 + (float)reservePercentage / 100.0);

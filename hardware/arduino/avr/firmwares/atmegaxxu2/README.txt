...
This directory contains the firmwares used on the ATmega8U2/Atmega16U2 on
the Arduino Uno and Arduino Mega 2560.  The arduino-usbdfu directory
contains the DFU bootloader; the arduino-usbserial directory contains the
actual usb to serial firmware.  Arduino-usbdfu should be compiled against
LUFA 100807 and arduino-usbserial should be compiled against LUFA 151115.

The two .hex files in this directory combine the dfu and serial firmwares into
a single file to burn onto the 8U2. (FIXME: the serial firmware in the
combined file is still version 001, whereas the arduino-usbserial folder

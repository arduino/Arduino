 ...
 *
 *  This header file "extends" the declarations provided by ti/drivers/bsp/Board.h
 *  with declarations that are specific to the tink2 hardware platform.
 *
 *  ============================================================================
 */
...
typedef enum Board_GPIOName {
    Board_GPIO13 = 0, 	/* Wiring id 3 (LP P1.3) LaunchPad SW3 on P1.3 */
    Board_GPIO_P1_3 = Board_GPIO13,
    Board_BUTTON1 = Board_GPIO13, 	/* LaunchPad SW3 on P1.3 */

    Board_GPIO22 = 1, 	/* Wiring id 11 (LP P2.10) LaunchPad SW2 button on P2.10 */
    Board_GPIO_P2_10 = Board_GPIO22,
    Board_BUTTON0 = Board_GPIO22, 	/* LaunchPad SW2 button on P2.10 */

    Board_GPIO9 = 2, 	/* Wiring id 29 (LP P3.9) Red LED_D7 */

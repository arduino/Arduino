...
#define portOutputRegister(P) ( (volatile uint8_t *)(portRegister(P)->OUT) )
#define portInputRegister(P)  ( (volatile uint8_t *)(portRegister(P)->IN) )
#define portModeRegister(P)   ( (volatile uint8_t *)(portRegister(P)->DIR) )
